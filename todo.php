...
if(isset($_GET['item'])){
  ...
  '<button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="edit()">'.'</button><button type="button" class="btn btn-default btn-xs fa fa-pencil" onclick="edit()" id="pencil_btn"></button>&nbsp;&nbsp;<i>'.$item.
